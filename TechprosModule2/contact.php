...
if(!empty($_GET)){
$to_email = 'ankit.see@gmail.com';
$subject = $_GET['nameOfuser'];
$message = $_GET['message']."/n".$_GET['phone'];
$headers = 'From: noreply'.$_GET['email'];
...
if ($secure_check == false) {
 ...
 echo "<script type='text/javascript'>alert('no submition');</script>"; 
}
*/

$sender = 'thephotowala@gmail.com';
$recipient = 'ankit.see@gmail.com';
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        ...
        <form name="sentMessage" id="contactForm" method="GET" action="contact.php" novalidate>
          <div class="control-group">
            <div class="form-group floating-label-form-group controls">
              <label>Name</label>
              <input name="nameOfuser" type="text" class="form-control" placeholder="Name" id="name" required data-validation-required-message="Please enter your name.">
